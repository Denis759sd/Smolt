                                ...
                                <form action="{{route('film.store')}}" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="exampleInputName" placeholder="Enter title" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="video_cdn" class="form-control" id="exampleInputName" placeholder="Enter url at video" required>
                                        </div>
